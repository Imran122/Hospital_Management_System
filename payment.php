...
<!-- diagonistic center -->
 ...
 <div class="card">
                ...
                <marquee direction="left" scrollamount="10" behavior="alternate" onmouseover="stop()" onmouseout="start()"><a href="">UPDATE AMOUNT</a></marquee>

                </div>

                <div class="card-body">
                    
                           <form class="form-group" action="payment_action.php" method="post">

                            
                          <label>First Name</label>                          
                          <input placeholder="First name only" type="text" name="fname" class="form-control"><br>
                          ...
                          <option value="due">Due</option>
                             ...
                             <input type="submit" class="btn btn-primary" name="pat_submit" value="Update">
