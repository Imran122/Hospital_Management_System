      ...
      <div class="row">
         ...
         <div class="col-md-8">
            <div class="card">
                ...
                <marquee direction="left" scrollamount="10" behavior="alternate" onmouseover="stop()" onmouseout="start()"><a href="">TESTS</a></marquee>

                </div>

                <div class="card-body">
                    
                           <form class="form-group" action="doctor_acc_action.php" method="post">
                              ...
                              <label>Contact:</label>
                              <input type="text" name="contatct" class="form-control"><br>
                               <label>Prescribe Here:</label>
                              <textarea rows="4" cols="50" name="press" ></textarea><br>

                               <label>TESTS:</label>
                             <select class="form-control" multiple size="3" name="test">
                              <option value="X ray">X ray</option>
                              <option value="Salmony paratyphi-A">Salmony paratyphi-A</option>
                              <option value="Urine culture">Urine culture</option>
                              <option value="CRP">CRP</option>
                              <option value="MRI">MRI</option>
                             </select><br>

                             <input type="submit" class="btn btn-primary" name="pat_sub" value="Enter">
