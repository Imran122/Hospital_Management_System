...
<!-- diagonistic center -->
	    	 ...
	    	 <div class="col-md-8">
	    	 	  <div class="card">
	    	 	  	  ...
	    	 	  	  <marquee direction="left" scrollamount="10" behavior="alternate" onmouseover="stop()" onmouseout="start()"><a href="">ADD STAFF DETAILS</a></marquee>

	    	 	  	  </div>

	    	 	  	  <div class="card-body">
	    	 	  	  	  
                           <form class="form-group" action="staff_action.php" method="post">

                              <label>First Name:</label>
                              <input type="text" name="fname" class="form-control"><br>

                              <label>Last Name:</label>
                              <input type="text" name="lname" class="form-control"><br>                              <label>Email id:</label>
                              <input type="text" name="email" class="form-control"><br>                              <label>Contact:</label>
                              <input type="text" name="contact" class="form-control"><br>                            <label>Address:</label>
                              <input type="text" name="address" class="form-control"><br>  

                             <input type="submit" class="btn btn-primary" name="pat_submit" value="Enter Details">
...
swal("Welcome Admin!", "You may proceed!", "success");
</script>
