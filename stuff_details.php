...
<head>
    ...
    <title>Patients details Enter</title>
         ...
         <div class="card">
                <!--marqueee and search part -->
              	    <div  class="card-body-first">
	    	 	  	  ...
	    	 	  	  <div class="col-md-7" >
	    	 	  	  <marquee direction="left" scrollamount="10" behavior="alternate" onmouseover="stop()" onmouseout="start()"><a href="">PATIENT DETAILS</a></marquee>
                       </div>

                       <div id="search" class="col-md-5" style="float: right;">
                       	    
                       	    <form class="from-group" action="search_patient.php" method="post">
                       	    	<input type="text" name="search" class="form-control" placeholder="Enter Contact">
                       	    	<input type="submit" name="patient_search_submit" value="search" class="btn btn-light" style="float: right;">
	    	 	   ...
	    	 	   <div class="card-body">
						  ...
						  <thead>
						    <tr>
						      ...
						      <th scope="col">Doctor Appointment Details</th>
						    </tr>
						  </thead>
						  <tbody>
						    <tr>
