...
<!-- diagonistic center -->
	    	 ...
	    	 <div class="col-md-8">
	    	 	  <div class="card">
	    	 	  	  ...
	    	 	  	  <marquee direction="left" scrollamount="10" behavior="alternate" onmouseover="stop()" onmouseout="start()"><a href="">BOOK AN APPOINMENT</a></marquee>

	    	 	  	  </div>

	    	 	  	  <div class="card-body">
	    	 	  	  	  
                           <form class="form-group" action="employe_account_action.php" method="post">
                          ...
                          <option value="due">Due</option>
                            ...
                            <label>Doctor Appoinment:</label>
                             <select class="form-control" name="docapp">
                             	<option value="Dr Sharma From 6pm">Dr Sharma From 6pm to 8pm</option>
                             	<option value="Dr Shetty From 4pm">Dr Shetty From 4pm to 6pm</option>
                             	<option value="Dr M Ali From 3pm">Dr M. Ali From 3pm to 4pm</option>
                             </select><br>
